...
- Alta variabilidade fúngica compromete a precisão, mesmo com bons algoritmos como o quantile random forest
...
<img src="./img/rcc.png" style="max-width: 80%; border-radius: 10px;" />
<img src="./img/rmc.png" style="max-width: 80%; border-radius: 10px;" />
...
<img src="./img/srr.png" style="max-width: 80%; border-radius: 10px;" />
<img src="./img/rtr.png" style="max-width: 80%; border-radius: 10px;" />
...
- A inclusão de variáveis texturais nos modelos aumentou a precisão das predições
...
- O modelo ajustado superou o modelo nulo com alta acurácia, mesmo com maior erro nos extremos  
